                    ...
                    <div className="bg-gradient-to-br from-[#101036] to-[#2d2db8] rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden flex flex-col justify-center text-center lg:text-left group shadow-2xl">
                        ...
                        <div className="relative z-10 flex flex-col items-center lg:items-start h-full justify-center">
                            ...
                            <a href={`https://wa.me/${WA_NUM}`} target="_blank" rel="noopener noreferrer" 
                                className="inline-flex items-center gap-3 bg-[#22c55e] hover:bg-[#1ea950] text-white px-8 py-4 rounded-full font-bold text-lg shadow-[0_10px_30px_rgba(34,197,94,0.3)] hover:-translate-y-1 transition-all duration-300"
                            >
                                <span>{c.ctaBtn}</span>
